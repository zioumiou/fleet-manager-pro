...
export const getMaintenances = (vehicleId?: number) => 
  api.get<Maintenance[]>('/maintenances/', { params: { vehicle_id: vehicleId } });
...
export const getFuels = (vehicleId?: number) => 
  api.get<Fuel[]>('/fuels/', { params: { vehicle_id: vehicleId } });
...
export const getExpenses = (vehicleId?: number) => 
  api.get<Expense[]>('/expenses/', { params: { vehicle_id: vehicleId } });
...
export const getTires = (vehicleId?: number) => 
  api.get<Tire[]>('/tires/', { params: { vehicle_id: vehicleId } });
...
export const exportMaintenancesExcel = () => api.get('/export/maintenances/excel', { responseType: 'blob' });
export const exportExpensesExcel = () => api.get('/export/expenses/excel', { responseType: 'blob' });
